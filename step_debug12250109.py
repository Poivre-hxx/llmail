...
class Tower:
    ...
    def in_range(self, enemy):
        distance = math.hypot((self.x + 0.5) * CELL_SIZE - enemy.x, (self.y + 0.5) * CELL_SIZE - enemy.y)
...
class Enemy:
    def __init__(self, start_pos):
        self.x, self.y = start_pos[0] * CELL_SIZE, start_pos[1] * CELL_SIZE
        self.health = 100
        self.max_health = 100
        self.speed = 1

    def move(self, path):
        target_index = path.index((int(self.x // CELL_SIZE), int(self.y // CELL_SIZE))) + 1
    ...
    def reached_end(self, end_pos):
        return (int(self.x // CELL_SIZE), int(self.y // CELL_SIZE)) == end_pos

    def draw(self, screen):
        x = int(self.x + CELL_SIZE // 2)
        y = int(self.y + CELL_SIZE // 2)
